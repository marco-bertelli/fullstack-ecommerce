    ...
    const {fullname, address1, address2, city, phone, zipCode}= address
        return (
            <div className="shipping-address">
                ...
                <Button width='100%' className='btn--orange'
                    style={{margin : '1rem 0'}}
                >Spedisci a questo indirizzo</Button>

                <div className="shipping-address__edit">
                    <FontAwesomeIcon icon={['fas','edit']} size='1x' style={{cursor:'pointer'}} />
                    <FontAwesomeIcon icon={['fas','trash-alt']} size='1x' color='red' style={{cursor:'pointer'}} />
                </div>
            </div>
        );
}
